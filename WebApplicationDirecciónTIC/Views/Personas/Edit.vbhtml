...
@Using (Html.BeginForm("Edit", "Personas", Nothing, FormMethod.Post, New With {.enctype = "multipart/form-data"}))
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <div class="col-md-10">
                    ...
                    <img src="@Html.DisplayFor(Function(model) model.Foto)" height="52" width="52" />
